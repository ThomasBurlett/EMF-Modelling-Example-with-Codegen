...
/**
 * This is the item provider adapter for a {@link com.burlette.emf.countries.model.countries.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						CountriesPackage.Literals.STATE__NAME, true, false, false,
	...
	protected void addPopulationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_population_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_population_feature",
								"_UI_State_type"),
						CountriesPackage.Literals.STATE__POPULATION, true, false, false,
	...
	protected void addTotalAreaPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_totalArea_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_totalArea_feature",
								"_UI_State_type"),
						CountriesPackage.Literals.STATE__TOTAL_AREA, true, false, false,
	...
	protected void addGovernorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_governor_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_governor_feature", "_UI_State_type"),
						CountriesPackage.Literals.STATE__GOVERNOR, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CountriesPackage.Literals.STATE__COUNTY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CountriesPackage.Literals.STATE__COUNTY,
				CountriesFactory.eINSTANCE.createCounty()));
	}
